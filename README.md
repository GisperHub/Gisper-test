    ...
    library:CreateWatermark("GISPER HUB") 
    _G.Color = Color3.fromRGB(157, 0, 225)
    _G.Color2 = Color3.fromRGB(0, 255, 171)
    local CenterHubNo1 = library:CreateWindow("GISPER HUB [BETA]| BLOX FRUIT",Enum.KeyCode.RightControl)
    local Tab = CenterHubNo1:CreateTab("AutoFarm")
    local AutoFarm = Tab:CreateSector("Main","Left")
...
function click()
 ...
 function TP(P)
   ...
   tween:Play()
    ...
    local AutoFarm = Tab:CreateSector("Weapon","Right")
    AutoFarm:AddLabel("Select Weapon")
    ...
    local AutoFarm = Tab:CreateSector("Tool","Right")
    AutoFarm:AddLabel("Tool Auto Farm")
